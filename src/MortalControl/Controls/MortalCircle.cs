...
namespace MortalControl.Controls
{
    ...
    public class MortalCircle : Control
    {
        ...
        private const int DefaultInnerCircleRadius = 20;
        private const int DefaultOuterCircleRadius = 15;
        private const int DefaultNumberOfSpoke = 13;
        ...
        /// </summary>
        /// <value>外围半径</value>
        [Description("获取和设置外围半径"), Category("LoadingCircle")]
        ...
        /// </summary>
        /// <value>内圆半径</value>
        [Description("获取和设置内圆半径"), Category("LoadingCircle")]
        ...
        /// </summary>
        /// <value>辐条数量</value>
        [Description("获取和设置辐条数量"), Category("LoadingCircle")]
        ...
        [Description("获取和设置一个布尔值，表示当前控件是否激活。"), Category("LoadingCircle")]
        public bool Active
        {
            get
            {
        ...
        /// </summary>
        /// <value>辐条粗细值</value>
        [Description("获取和设置辐条粗细程度。"), Category("LoadingCircle")]
